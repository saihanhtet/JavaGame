...
public class Old {
    ...
    public static int[][] DeployPlayerShip(int ShipsCount){
        ...
        for (int ship = 0; ship< Old.playerShips; ship++){
    ...
    public static void DeployComputerShip(int ShipsCount,int[][] PlayerShipPlaces){
        ...
        int[][] shipCoordinates = new int[ShipsCount][2];
        for (int ship = 0; ship< Old.computerShips; ship++){
    ...
    public static void main(String[] args) {
        ...
        Old.playerShips = Old.computerShips = 5;

        int[][] playerShipOnBoard = DeployPlayerShip(Old.playerShips);
        createMap();
        DeployComputerShip(Old.computerShips,playerShipOnBoard);
        createMap();
